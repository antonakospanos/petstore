(function () {
  ...
  var app = angular
  .module("PetStoreUi",
      ["ui.bootstrap", "ui.router", "ngSanitize", "ngTable", "ngCookies",
        "ngCookies", "ngMaterial", "ui.sortable", "ngMessages",
        "md.time.picker"])
  .config(config)
  .run(run);
  ...
  function config($stateProvider, $urlRouterProvider) {
    ...
    // Pets Review (homepage)
    $stateProvider.state("pets_review", {
      url: "/",
      templateUrl: "app/components/pets-review/views/petsReview.html",
    });

    // Pet Buy after login
    $stateProvider.state("pets_buy", {
      url: "/buy",
      templateUrl: "app/components/pets-sales/views/petsSales.html",
      params: {
        pet: undefined
      }
    });
   ...
   *  b) Root scope setup
   */
  run.$inject = ['$rootScope', '$location', '$cookies', '$http', "$modal",
    "$q"];
  ...
  app.controller("RootController",
      ["$rootScope", "$scope", "$cookies", "$http", "$mdToast", '$controller',
        "$state",
